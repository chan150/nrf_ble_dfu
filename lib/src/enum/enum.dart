...
enum NrfDfuOp {
  ...
  receiptNotifSet(code: 0x02, description: 'NRF_DFU_RES_CODE_OP_CODE_NOT_SUPPORTED'),
  crcGet(code: 0x03, description: 'NRF_DFU_RES_CODE_INVALID_PARAMETER'),
  objectExecute(code: 0x04, description: 'NRF_DFU_RES_CODE_INSUFFICIENT_RESOURCES'),
  ...
  objectWrite(code: 0x08, description: 'NRF_DFU_RES_CODE_OPERATION_NOT_PERMITTED'),
...
enum NrfDfuResult {
  ...
  notSupported(code: 0x02, description: 'NRF_DFU_RES_CODE_OP_CODE_NOT_SUPPORTED'),
  invalidParameter(code: 0x03, description: 'NRF_DFU_RES_CODE_INVALID_PARAMETER'),
  insufficientResources(code: 0x04, description: 'NRF_DFU_RES_CODE_INSUFFICIENT_RESOURCES'),
  invalidObject(code: 0x05, description: 'NRF_DFU_RES_CODE_INVALID_OBJECT'),
  notSupportedType(code: 0x07, description: 'NRF_DFU_RES_CODE_UNSUPPORTED_TYPE'),
  operationNotPermitted(code: 0x08, description: 'NRF_DFU_RES_CODE_OPERATION_NOT_PERMITTED'),
